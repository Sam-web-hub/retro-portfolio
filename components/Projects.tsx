...
const typeColors: Record<string, string> = {
  "Full-Stack": "text-[#5a7a5a] border-[#5a7a5a]",
  Frontend: "text-[#8b6914] border-[#8b6914]",
  Backend: "text-[#b84c1a] border-[#b84c1a]",
  OSS: "text-[#1a1209] border-[#1a1209]",
};
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      ref={ref}
      className="relative py-28 px-6 bg-[#ede8de]"
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <h2 className="font-display text-4xl text-[#1a1209]">Projects</h2>
            <div className="flex-1 h-px bg-[#c4b89a]" />
          </div>
          <p className="font-body text-[#5a4a30] mb-16 ml-10">
            Selected work — a few things I&apos;ve built and shipped.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project, i) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-display text-2xl text-[#1a1209] mb-3">
                {project.title}
              </h3>

              {/* Description */}
              <p className="font-body text-sm text-[#5a4a30] leading-relaxed mb-5">
                {project.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="font-mono text-[10px] uppercase tracking-wider bg-[#ede8de] text-[#8b6914] px-2 py-1"
                  >
                    {tag}
                  </span>
                ))}
